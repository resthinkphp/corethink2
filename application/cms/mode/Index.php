...
class Index extends Model {
    ...
    public function update() {
        ...
        $doc_type_info = D($this->moduleName.'/Type')->where(array('id' => $category_info['doc_type']))->find()->toArray();
    ...
    public function detail($id, $map = null) {
        ...
        $info = $this->where($con)->find()->toArray();
        if (!is_array($info)) {
    ...
    private function getPrevious($info) {
        ...
        $previous = $this->where($map)->order('id desc')->find()->toArray();
    ...
    private function getNext($info) {
        ...
        $map['cid'] = array('eq', $info['cid']);
        $next = $this->where($map)->order('id asc')->find()->toArray();
